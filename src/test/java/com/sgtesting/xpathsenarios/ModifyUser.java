...
public class ModifyUser
{
    ...
    public static void main(String[] args)
    {
        ...
        createUser();
        modifyUser("Mudalagi, Hanamant","Pavan","Goudra");
        deleteUser("Goudra, Pavan");
        logout();
        closeBrowser();
    }
    ...
    private static void modifyUser(String fullName,String newFirstName,String newLastName)
    {
        try
        {
            ...
            Thread.sleep(2000);
            driver.findElement(By.xpath("//input[@name='firstName']")).sendKeys(newFirstName);
