...
public class ModifyProject
{
    ...
    public static void main(String[] args)
    {
        ...
        modifyProject("ChargeBack" ,"ChargeBacks");
        deleteProject();
        deleteCustomer();
        logout();
        closeBrowser();
    ...
    private static void modifyProject(String oldName, String newName)
    {
        try
        {
            driver.findElement(By.xpath("(//div[@class='editButton available'])[2]")).click();
            Thread.sleep(2000);
            driver.findElement(By.xpath("(//div[@class='nameLabel'][normalize-space()='"+oldName+"'])[1]")).click();
            Thread.sleep(2000);
            driver.findElement(By.xpath("(//input[@placeholder='Enter Project Name'])[2]")).clear();
            Thread.sleep(1000);
            driver.findElement(By.xpath("(//input[@placeholder='Enter Project Name'])[2]")).sendKeys(newName);
            Thread.sleep(2000);
            driver.findElement(By.xpath("(//div[@class='closeButton'])[9]")).click();
            Thread.sleep(2000);
        } catch (Exception e)
        {
            e.printStackTrace();
