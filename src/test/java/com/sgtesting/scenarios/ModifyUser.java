...
public class ModifyUser
{
    ...
    private static void modifyUser()
    {
        try
        {
            driver.findElement(By.xpath("//span[@class='userNameSpan'][normalize-space()='Mudalagi, Hanamant']")).click();
            driver.findElement(By.name("firstName")).clear();
            Thread.sleep(2000);
            driver.findElement(By.name("firstName")).sendKeys("pavan");
            driver.findElement(By.name("lastName")).clear();
            Thread.sleep(2000);
            driver.findElement(By.name("lastName")).sendKeys("Goudru");
    ...
    private static void deleteUser()
    {
        ...
        try
        {
            driver.findElement(By.xpath("//span[normalize-space()='Goudru, pavan']")).click();
