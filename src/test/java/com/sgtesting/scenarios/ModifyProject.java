...
public class ModifyProject
{
    ...
    private static void modifyProject(String oldName, String newName)
    {
        try
        {
            ...
            Thread.sleep(2000);
            driver.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Project Name']")).clear();
            Thread.sleep(1000);
            driver.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Project Name']")).sendKeys(newName);
            Thread.sleep(2000);
            driver.findElement(By.xpath("//div[@class='headerBlock hideTabs']//div[@class='closeButton']")).click();
            Thread.sleep(2000);
        } catch (Exception e)
        {
            e.printStackTrace();
