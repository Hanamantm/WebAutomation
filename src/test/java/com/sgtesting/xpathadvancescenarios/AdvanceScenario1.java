package com.sgtesting.xpathadvancescenarios;
...
public class AdvanceScenario1
{
    ...
    private static void login(String username, String password)
    {
        try
        {
            ...
            // Handle “Start Exploring” link if present
    ...
    private static void createUser(String fn,String ln, String email, String uname, String pwd)
    {
        try
        {
            ...
            driver.findElement(By.xpath("//input[@name='passwordCopy']")).sendKeys(pwd);

            driver.findElement(By.xpath("//div[@id='userDataLightBox_commitBtn']//div[contains(@class,'buttonIcon')]")).click();
            Thread.sleep(4000);
        }catch (Exception e)
        {
            e.printStackTrace();
    ...
    private static void modifyUserPassword(String fullName,String newPwd)
    {
        try
        {
            ...
            driver.findElement(By.xpath("//span[@class='userNameSpan' and normalize-space(text())='" + fullName + "']")).click();
            Thread.sleep(2000);
    ...
    private static void deleteUser(String deleteuser)
    {
        try
        {
            ...
            driver.findElement(By.xpath("//span[@class='userNameSpan' and normalize-space(text())='" + deleteuser + "']")).click();
            Thread.sleep(2000);
            ...
            System.out.println("Alert Message: " + oAlert.getText());
            oAlert.accept();
            Thread.sleep(2000);
