...
public class AdvancedScenario2
{
    ...
    private static void modifyUserPassword(String fullName, String newPwd)
    {
        try
        {
            driver.findElement(By.xpath("//span[@class='userNameSpan' and normalize-space()='" + fullName + "']")).click();
            Thread.sleep(2000);
    ...
    private static void deleteUser(String deleteuser)
    {
        try
        {
            driver.findElement(By.xpath("//span[@class='userNameSpan' and normalize-space()='" + deleteuser + "']")).click();
            Thread.sleep(2000);
