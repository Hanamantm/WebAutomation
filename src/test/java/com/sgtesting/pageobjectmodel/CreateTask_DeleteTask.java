...
public class CreateTask_DeleteTask
{
    ...
    private static void createTask()
    {
        try
        {
            page.getNewTask().click();
            Thread.sleep(2000);
            page.getAddNewTask().click();
            Thread.sleep(2000);
            page.getTaskName().sendKeys("add wholesaler");
            Thread.sleep(2000);
            page.getCreateTask().click();
            Thread.sleep(2000);
        } catch (Exception e)
        {
            e.printStackTrace();
    ...
    private static void deleteTask()
    {
        try
        {
            page.getClickOnTask().click();
            Thread.sleep(2000);
            page.getDeleteTaskButton().click();
            Thread.sleep(2000);
            page.getDeleteConfirmTask().click();
            Thread.sleep(2000);
            page.getSubmitTitle().click();
            Thread.sleep(2000);
        } catch (Exception e)
        {
            e.printStackTrace();
