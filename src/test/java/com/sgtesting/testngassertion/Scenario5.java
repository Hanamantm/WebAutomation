...
public class Scenario5
{
    ...
    private static void Modifyproject(String ModProjName,String ModProjDetails,String Custname,String ProjName){
        try{
            oBrowser.findElement(By.xpath("//div[@class='node projectNode selected']//div[@class='editButton available']")).click();
            Thread.sleep(4000);

            WebElement oEle=oBrowser.findElement(By.xpath("//span[text()='" + Custname + "'] "));
            Assert.assertTrue(oEle.isDisplayed());//td[text()='Enter Time-Track']
            Thread.sleep(2000);

            oBrowser.findElement(By.xpath("//div[@class='nameLabel'][normalize-space()='"+ProjName+"']")).click();
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Project Name']")).clear();
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Project Name']")).sendKeys(ModProjName);
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//textarea[@placeholder='Enter project description...']")).click();
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//textarea[@placeholder='Enter project description...']")).clear();
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//textarea[@placeholder='Enter project description...']")).sendKeys(ModProjDetails);
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//div[@class='headerBlock hideTabs']//div[@class='closeButton']")).click();
            Thread.sleep(2000);
    ...
    @Test(priority = 8,dataProvider = "Deleteproject")
    private static void Deleteproject(String projectName)
    {
        try {
            ...
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("(//div[@class='buttonIcon'])[4]")).click();
            Thread.sleep(2000);
    ...
    public Object[][] getModifiedProjectDetails()
    {
        return new Object[][] {{"ChargeBacks","completed Project","TCS","ChargeBack"}};
