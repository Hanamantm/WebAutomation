...
public class Scenario3
{
    ...
    @Test(priority = 6, dataProvider = "ModifyCustomerDetails")
    private static void Modifycustomer(String OldCustname,String modCustname,String modCustDetails )
    {
        try {
            ...
            Assert.assertTrue(oEle.isDisplayed());
            Thread.sleep(2000);
            oBrowser.findElement(By.xpath("//div[@class='nameLabel'][normalize-space()='" + OldCustname + "']")).click();
            Thread.sleep(2000);
            oBrowser.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Customer Name']")).clear();
            Thread.sleep(2000);
            oBrowser.findElement(By.xpath("//div[@class='nameInput']//input[@placeholder='Enter Customer Name']")).sendKeys(modCustname);
            Thread.sleep(2000);
            oBrowser.findElement(By.xpath("//textarea[@placeholder='Enter customer description...']")).clear();
            Thread.sleep(2000);
            oBrowser.findElement(By.xpath("//textarea[@placeholder='Enter customer description...']")).sendKeys(modCustDetails);
            Thread.sleep(1000);
            oBrowser.findElement(By.xpath("//div[@class='edit_customer_sliding_panel sliding_panel']//div[@class='closeButton']")).click();
            Thread.sleep(4000);
    ...
    public Object[][] getModifiedCustomerDetails()
    {
        return new Object[][] {{"TCS","Wipro","waiting for final report"}};
